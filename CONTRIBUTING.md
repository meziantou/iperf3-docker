...
Please read these guidelines before contributing to meziantou/iperf3-docker:
...
If you have questions about how to use meziantou/iperf3-docker, please open a GitHub issue.
...
- Check that new and updated code follows meziantou/iperf3-docker's existing code formatting and naming standard
- Run meziantou/iperf3-docker's unit tests to ensure no existing functionality has been affected
...
By contributing your code to meziantou/iperf3-docker you grant Gérald Barré a non-exclusive, irrevocable, worldwide,
